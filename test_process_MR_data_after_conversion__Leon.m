...
ori_img_file = 'test1.mgz'; copyfile(ori_img_file, '/home/leon/Cloud_GUI/temptest.mgz');
...
[status msg] = system('cd /home/leon/FastSurfer; ./run_fastsurfer.sh --t1 /home/leon/Cloud_GUI/temptest.mgz --sid subject1 --sd /home/leon/my_fastsurfer_analysis --seg_only','-echo');
...
img_file = '/home/leon/Cloud_GUI/temptest.mgz';
